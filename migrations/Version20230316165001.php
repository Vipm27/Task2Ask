 ...
 */
final class Version20230316165001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recommendation (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, temperature_min DOUBLE PRECISION NOT NULL, temperature_max DOUBLE PRECISION NOT NULL, humidity_min DOUBLE PRECISION NOT NULL, humidity_max DOUBLE PRECISION NOT NULL, illumination_min DOUBLE PRECISION NOT NULL, illumination_max DOUBLE PRECISION NOT NULL, description_care LONGTEXT NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, created_by INT NOT NULL, modified_by INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, recommendation_id INT DEFAULT NULL, description LONGTEXT NOT NULL, name VARCHAR(255) NOT NULL, created_by INT NOT NULL, modified_at DATETIME NOT NULL, modified_by INT NOT NULL, INDEX IDX_8CDE5729D173940B (recommendation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
